...
<!---form richiesta info--->
    <asp:Panel ID="Panel1" Visible="false" runat="server">
        <div class="tbl1" style="padding: 10px; background-color: #D0DBE6; margin:auto; text-align:center; width:550px">
    ...
    <asp:Panel ID="Panel3" Visible="false" runat="server">
        <div class="tbl1" style="padding: 10px; background-color: #D0DBE6; text-align:center; width:550px; margin:auto">
            ...
            <asp:Button ID="Button1" OnClick="Button1_Click" runat="server" Text="Torna all'immobile" />
        </div>
    </asp:Panel>
                ...
                <table class="tbl1">
                        ...
                        <td style="padding-left: 10px; height: 55px; background-color: #3E5873; color: #FFFFFF;" colspan="4">
                            <span class="galla">
                                <a class="labRigth" style="color: #fff" href="ImmGall.aspx?id=<%# Eval("Id")%>">
                                    ...
                                    Galleria fotografica</a> </span><span style="float: left; margin-left: 40px">Codice immobile: 
                                        <asp:Label ID="LabelBoxCodice" CssClass="LabelForm" runat="server" Text='<%# Eval("Codice") %>' /></span>
                            - Città:
                            <asp:Label ID="LabelBoxCittà" CssClass="LabelForm" runat="server" Text='<%# Bind("Città") %>' />
                            - Provincia:
                            <asp:Label ID="LabelBoxProvincia" CssClass="LabelForm" Width="30px" runat="server" Text='<%# Bind("Provincia") %>' />
                            <div>
                                <br />
                                <asp:LinkButton ID="LinkButton2" ForeColor="White" runat="server" OnClick="LinkButton2_Click">contattaci per informazioni su questo immobile</asp:LinkButton>
                            </div>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <span class="labRigth">
                                <asp:Label ID="LabelBoxTipologia" runat="server" Text='<%# Bind("Tip") %>' />
                            </span>
                        </td>
                        <td>
                        ...
                        <td>
                            ...
                            <span class="labRigth">
                                <asp:Label ID="LabelBoxPrezzo" runat="server" Text='<%# Bind("Prezzo", "{0:C0}") %>' />
                            </span>
                        </td>
                    </tr>
                    <tr>
