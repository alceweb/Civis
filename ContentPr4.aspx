<%@ Page Title="" Language="C#" MasterPageFile="~/Prestigio.master" AutoEventWireup="true" CodeFile="ContentPr4.aspx.cs" Inherits="ContentPr4" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <h2 class="h2content">Immobile quattro
        <span>
    ...
    <asp:Panel ID="PanelImg" Visible="true" runat="server">
        <img class="bodyImg" src="Images/Slides/Prestigio4.jpg" />
    </asp:Panel>
    ...
    <asp:Panel ID="Panel2" Visible="false" runat="server">
        ...
        <div class="caption">
            <a href="Images/Slides/Prestigio4.jpg"><img src="Images/Slides/Prestigio4.jpg" alt="" />
            <span>
