<%@ Page Title="" Language="C#" MasterPageFile="~/Prestigio.master" AutoEventWireup="true" CodeFile="ContentPr3.aspx.cs" Inherits="ContentPr3" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <h2 class="h2content">Immobile tre
        <span>
    ...
    <asp:Panel ID="PanelImg" Visible="true" runat="server">
        <img class="bodyImg" src="Images/Slides/Prestigio3.jpg" />
    </asp:Panel>
    ...
    <asp:Panel ID="Panel2" Visible="false" runat="server">
        ...
        <div class="caption">
            <a href="Images/Slides/Prestigio3.jpg"><img src="Images/Slides/Prestigio3.jpg" alt="" />
            <span>
