<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="ListaImm.aspx.cs" Inherits="Riservata_ListaImm" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" Runat="Server">
    <p class="TitoloVetrina">Lista immobili per area riservata</p>
    <div class="ListImm" >
        ...
        <asp:GridView ID="GridView1" Width="1024px" runat="server" AllowSorting="True" CellPadding="1" DataSourceID="SqlDataSource1" ForeColor="#333333" GridLines="None" AutoGenerateColumns="False">
            ...
            <Columns>
                <asp:TemplateField HeaderText="">
                    <ItemTemplate>
                        <a href='ImmModifica.aspx?id=<%#Eval("id")%>' >Scheda</a>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="">
                    <ItemTemplate>
                        <a href='GestioneImmobile.aspx?id=<%#Eval("id")%>' >Immagini</a>
                    </ItemTemplate>
                </asp:TemplateField>
